...
Ext.create('Ext.data.Store', {
	...
	data: [
		...
		{content: '<p class="item-style4"><font face="微软雅黑">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们团队是一个五人组（按姓氏笔画排名）：' + '<br />' + 
			...
			'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;谢华梁，男，河北秦皇岛人士；' + '<br />' + 
			'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;黄<font color="white">一</font>骁，男，山东？？人士。</font></p>', 
			value: '我们团队'},
                    ...
                    items: [
                        {
							...
							items: [							
									...
									items: [
										...
										},
										{
											...
											},
											{
												...
												handler: function (button) {
													chooseaddress.showBy(button);
													thumiao.PhoneSencha.buttonCatMap();
												}
											},
											{
												xtype: 'spacer'
								...
								// 	xtype: 'panel',
								// 	title: '数据',
								// 	//html: "<div class='thu_CICatDatas'><div class='thu_CICatDataStr'>请为我添加更多的数据~</div><div id='CICatData0'></div></div>"+
								// 	//"<div class='thu_CICatDatas'><div class='thu_CICatDataStr'>请为我添加更多的数据~</div><div id='CICatData1'></div></div>",
								// 	//layout: 'card2',
								// 	iconCls: 'info',
								// 	cls: 'card2',
								// 	displayField: 'title',
										...
										//上方栏
										{
											...
											items: [
												...
												//刷新
												{
													...
													delegate: 'button',
													handler: function (button) {
														thumiao.PhoneSencha.catImpCall("Succeed");
													}
												},
